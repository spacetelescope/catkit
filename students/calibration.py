...
#X
pre_image = zwo_cam.take_exposure(exp_time=exposure_time_sc)
zwo_cam.plot_image(pre_image, output_name='test_image_precal.png')
pm.command('relative_move',1,100)
time.sleep(2)
post_image = zwo_cam.take_exposure(exp_time=exposure_time_sc)
...
regular = zwo_cam.take_exposure(exp_time=exposure_time_sc)
...
if disable:
	#X
	pre_image = zwo_cam_tac.take_exposure(exp_time=exposure_time_ta)
	pm.command('relative_move',1,100)
	time.sleep(2)
	post_image = zwo_cam_tac.take_exposure(exp_time=exposure_time_ta)
	print("Calculating pixel to picomotor step ratio...\n")
