...
#X
pre_image = zwo_cam.take_exposure(exp_time=exposure_time*10)
zwo_cam.plot_image(pre_image, output_name='test_image_precal.png')
pm.command('relative_move',1,100)
time.sleep(2)
post_image = zwo_cam.take_exposure(exp_time=exposure_time*10)
...
regular = zwo_cam.take_exposure(exp_time=exposure_time*10)
...
try:
	...
	time.sleep(2)
	regular2 = zwo_cam.take_exposure(exp_time=exposure_time*10)
...
try:
	if disable:
		#X
		pre_image = zwo_cam_tac.take_exposure(exp_time=exposure_time)
		pm.command('relative_move',1,100)
		time.sleep(2)
		post_image = zwo_cam_tac.take_exposure(exp_time=exposure_time)
		print("Calculating pixel to picomotor step ratio...\n")
