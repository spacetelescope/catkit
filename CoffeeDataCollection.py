...
class CoffeeDataCollection(Experiment):
    ...
    def experiment(self):
        ...
        take_exposures_dm_commands(focus_zernike_command_paths, local_path, "letter_f_and_focus", self.coron_exp_time,
                                   self.direct_exp_time, list_of_paths=False, num_exposures=self.num_exposures,
                                   dm1_command_object=letter_f)

        # DM1 OFF and DM2 focus loop.
        take_exposures_dm_commands(focus_zernike_command_paths, local_path, "focus_dm1_off",
                                   dm1_command_object=commands.flat_command(bias=False, flat_map=False),
                                   num_exposures=self.num_exposures)
