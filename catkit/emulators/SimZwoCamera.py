...
#
        ...
        # For simulation purposes we need to work backwards from the name (ID) to figure
        # out the logical purpose of this camera - since of course we can't rely on the
        # position on the table of each piece of hardware!
...
#        return camera
    ...
    def take_exposures(self, exposure_time, num_exposures,
        ...
        self.log.info("HICAT_SIM: Exposure t = {exposure_time}, nexp={num_exposures}".format(
    ...
    def flash_id(self, new_id):
        ...
        raise NotImplementedError("Neet to write simulated version")
    ...
    def __setup_control_values(self, exposure_time, subarray_x=None, subarray_y=None, width=None, height=None,
        ...
        # FIXME get the correct values for here
        detector_max_x = 4096 # cam_info['MaxWidth']
        detector_max_y = 4096 # cam_info['MaxHeight']
        ...
        if not full_image:
            pass # No need to do anything here - the simulated detector will already be set up
                 # consistently with the config file settings.
    ...
    def __capture(self, exposure_time):
        ...
        counts_per_microsec = CONFIG_INI.getfloat(
            'photometry', photometry_config_key, fallback=90000)
