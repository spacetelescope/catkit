...
class PastisModeContrast(PastisExperiment):
    ...
    def __init__(self, pastis_results_path, pastis_matrix_path, use_uniform_weights, individual, c_target, probe_filename, dm_map_path, wavelength, nd_direct, nd_coron,
